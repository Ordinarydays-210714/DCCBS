...
public:
	...
	// set params for DCCBS
	void setSearchRange(int h) { search_range = h; heuristic_helper.search_range = h; }
	void setSearchDecayingRate(int r) { search_decaying_rate = r; heuristic_helper.search_decaying_rate = r; }
	void setSearchDecayingPeriod(int p) { search_decaying_period = p; heuristic_helper.search_decaying_period = p; }
	void setMinSearchRange(int l) { min_search_range = l; heuristic_helper.min_search_range = l; }
